...
# Passo 2 - Adicionar os pacotes NuGet necessários
...
# Passo 3 - Criar a solução e adicionar os projetos
...
# Passo 4 - Limpar código do Program.cs e remover arquivos desnecessários no projeto de API
...
# Passo 5 - Criar a classe ApiEndpoints no projeto de API para organizar os endpoints da aplicação
...
# Passo 6 - Criar a class ApplicationDbContext na pasta Data do projeto de infraestrutura data
...
# Passo 7 - Criar PostgreSqlExtensions na pasta Extensions do projeto de infraestrutura crosscutting IoC
...
# Passo 8 - Criar o appsettings.json para os ambientes de desenvolvimento, homologação e produção
